...
<webui-report label="Results" api="https://api.myfi.ws/mock/report" filters="mock-report-filter" sort-column="name" bordered theme="info" sortable="id;name;note" append-columns=":Action:" data-subscribe="report-refresh:loadData">
